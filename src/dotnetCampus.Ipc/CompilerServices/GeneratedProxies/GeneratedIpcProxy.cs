...
public abstract class GeneratedIpcProxy<TContract> : GeneratedIpcProxy where TContract : class
{
    ...
    protected Task CallMethod(ulong memberId, IGarmObject[]? args, IpcProxyMemberNamedValues namedValues, [CallerMemberName] string methodName = "")
    {
    ...
    /// <param name="methodName">方法名。</param>
    /// <returns>可异步等待方法返回值的可等待对象。</returns>
    protected Task<T?> CallMethod<T>(ulong memberId, IGarmObject[]? args, IpcProxyMemberNamedValues namedValues, [CallerMemberName] string methodName = "")
    {
    ...
    /// <param name="methodName">方法名。</param>
    /// <returns>可异步等待方法返回值的可等待对象。</returns>
    protected Task CallMethodAsync(ulong memberId, IGarmObject[]? args, IpcProxyMemberNamedValues namedValues, [CallerMemberName] string methodName = "")
    {
    ...
    /// <param name="methodName">方法名。</param>
    /// <returns>可异步等待方法返回值的可等待对象。</returns>
    protected Task<T?> CallMethodAsync<T>(ulong memberId, IGarmObject[]? args, IpcProxyMemberNamedValues namedValues, [CallerMemberName] string methodName = "")
    {
    ...
    /// <returns>可异步等待方法返回值的可等待对象。</returns>
    private async Task<T?> IpcInvokeAsync<T>(MemberInvokingType callType, ulong memberId, string memberName, IGarmObject[]? args, IpcProxyMemberNamedValues namedValues)
    {
